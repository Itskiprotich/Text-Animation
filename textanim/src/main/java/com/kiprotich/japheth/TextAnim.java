...
public class TextAnim extends View {
     ...
     */
    public TextAnim setColor(int color){
     ...
     */
    public TextAnim setWidth(float width){
     ...
     */
    public TextAnim setDelay(int delay){
     ...
     */
    public TextAnim setSizeFactor(float sizeFactor){
     ...
     */
    public TextAnim setLetterSpacing(float spacing){
     ...
     */
    public TextAnim setConfig(Configuration config){
     ...
     */
    public TextAnim setText(String text){
     ...
     */
    public TextAnim setListener(Listener listener){
